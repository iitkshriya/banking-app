  ...
  <div>
    <div class="flex gap-8">
      <button
        ...
        :class="[activeTab === index ? 'font-bold' : 'font-regular']"
      >
        {{ tab.label }}
        <span
    ...
    <div class="mt-4">
      <component
        :is="componentsList[tabs[activeTab].content as TabComponentsKeys]"
        v-bind="{ ...tabs[activeTab].props, activeTab: tabs[activeTab].id }"
