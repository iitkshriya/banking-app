<template>
  ...
  >
    ...
    <div class="mt-12 h-6 w-32 bg-green-400 rounded"></div>

    <div class="mt-8 mb-5 h-4 w-3/4 bg-green-400 rounded"></div>

    <div class="flex mt-4">
      <div class="h-4 w-20 bg-green-400 rounded"></div>
      <div class="h-4 w-16 bg-green-400 rounded mx-6"></div>
    </div>

    <div class="absolute bottom-0 right-0 mb-6 mr-6 h-6 w-12 bg-green-400 rounded"></div>
  </div>
</template>
